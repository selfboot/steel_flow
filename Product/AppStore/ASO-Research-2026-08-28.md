...
最大不确定性不是技术，而是用户是否愿意为“完整报价工作流”支付 ¥68 / US$14.99，而不是满足于免费单次算重。
...
| 主类目 | 工具 | Utilities |
| 次类目 | 商务 | Business |
| 定价 | 免费下载 + Pro 永久版 ¥68 首发 | Free + Pro Lifetime US$14.99 launch |
...
- 中国大陆首发：¥68；积累 20–30 个高质量评分并验证报价导出使用后，再测试 ¥88。
- 美国首发：US$14.99；验证专业用户转化后测试 US$19.99。
...
当前已用真实 App 界面完成中英文首屏封面。第 2–6 页文案与版式已预置，但仍应在上架前补拍对应的计算详情、项目汇总、报价预览、材料库和设置/备份真实界面，不建议最终六页重复使用首页截图。
...
3. 分开记录“看到价格页”“选择 ¥68/US$14.99”“TestFlight 申请”“实际导出 PDF”四层信号。
